...
import { getListofAssetHistoryByIdAsync } from '../../redux/slices/assetSlice';
...
const TABLE_HEAD = [
  ...
  { id: 'empName', label: 'Emp_Name', alignRight: false, margin: '' },
...
export default function AssetHistory() {
  ...
  useEffect(() => {
    dispatch(getListofAssetHistoryByIdAsync());
  }, [dispatch]);
          ...
          action={
            <>
              ...
              {/* <Button
                variant="contained"
                component={RouterLink}
                to={PATH_DASHBOARD.admin.assetAssign}
                startIcon={<Icon icon={plusFill} />}
              >
                User Details
              </Button>{' '} */}
              {/* <Button
                variant="contained"
                component={RouterLink}
                to={PATH_DASHBOARD.admin.unassignedAsset}
                startIcon={<Icon icon={plusFill} />}
              >
                UnAssigned Asset
              </Button>{' '} */}
