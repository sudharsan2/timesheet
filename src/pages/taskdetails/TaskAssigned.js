...
import TaskMoreMenu from '../../components/_administrator/list/TaskMoreMenu';
// redux
import { useDispatch, useSelector } from '../../redux/store';
import { getManagerTaskAssignToAsync } from '../../redux/slices/taskSlice';
...
export default function AssignedTasks() {
  ...
  const [isNewRowEnabled, setNewRow] = useState(false);
  const [isEditEnabled, setEditRow] = useState(false);
  ...
  useEffect(() => {
    dispatch(getManagerTaskAssignToAsync());
  }, [dispatch]);
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: 'Task List', href: PATH_DASHBOARD.task.taskList },
            { name: 'List' }
          ]}
        />
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <TaskMoreMenu managerId={managerId} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
