...
// import IssueListToolbar from 'src/components/_administrator/list/IssuesListToolbar';
...
export default function IssueListToolbar({ numSelected, filterName, onFilterName, handleBulkApproval, handleDelete }) {
