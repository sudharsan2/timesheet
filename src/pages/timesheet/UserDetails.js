...
import { getUserAssetDetailsAsync } from '../../redux/slices/assetSlice';
...
const TABLE_HEAD = [
  ...
  { id: 'empId', label: 'EMPLOYEE_ID', alignRight: false, margin: '' },
...
export default function UserList() {
  ...
  useEffect(() => {
    dispatch(getUserAssetDetailsAsync());
  }, [dispatch]);
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: 'Asset details', href: PATH_DASHBOARD.admin },
            { name: 'List' }
          ]}
          action={
            <>
              ...
              <Button
                variant="contained"
                component={RouterLink}
                to={PATH_DASHBOARD.timesheet.historyAsset}
                // startIcon={<Icon icon={plusFill} />}
              >
                Issue History
              </Button>{' '}
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center">
                          ...
                          >
                            <ListItemIcon>
                              <Icon icon={editFill} inline style={{ color: 'Red' }} width={20} height={20} />
                            </ListItemIcon>
                          ...
                          <Button
                            variant="contained"
                            component={RouterLink}
                            to={`${PATH_DASHBOARD.timesheet.applyIssue}/${assetId}`}
