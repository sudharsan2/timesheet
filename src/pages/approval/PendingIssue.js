...
import { getPendingIssueAssetAsync } from '../../redux/slices/assetSlice';
...
export default function PendingIssue() {
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: 'Issue List', href: PATH_DASHBOARD.timesheet.approveIssue },
            { name: 'Pending' }
          ]}
          action={
            <>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row12) => {
                    const { asset_id: assetId, empId, submittedOn, reason, description, status } = row12;
