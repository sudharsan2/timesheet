...
const TABLE_HEAD = [
  { id: 'project', label: 'Emp No', alignRight: false, margin: '' },
  { id: 'date_of_travel', label: 'Emp Name', alignRight: false, margin: '' },
  { id: 'travel_mode', label: 'Req date', alignRight: false, margin: '' },
  { id: 'approver', label: 'Action', alignRight: false, margin: '' }
];
              ...
              <Table>
                ...
                <TableBody>
                  ...
                  >
                    ...
                    <TableCell>M1317</TableCell>
                    <TableCell>Ajay P</TableCell>
                    <TableCell>04/11/23</TableCell>
                    <TableCell align="left">
                      <IconButton
                        aria-label="Edit"
                        component={RouterLink}
                        // to={`${paths.PATH_DASHBOARD.review.editWeekRev}/${projeId}`}
                        to={PATH_DASHBOARD.travel.statusApproval}
                      >
                        <EditIcon />
                      </IconButton>
                    </TableCell>{' '}
