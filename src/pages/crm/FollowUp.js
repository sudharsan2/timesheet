...
export default function FollowUp() {
  ...
  const startChange = (event) => {
    ...
    axios
      .post(
        'https://techstephub.focusrtech.com:3030/techstep/api/CrmLead/Service/getFollowUpNotification',
        {
          // follow_up_date: localStorage.getItem('select')
                  ...
                  {newArr.map((x, i) => {
                    return (
                      <TableRow key={i}>
                        ...
                        <TableCell>{x.is_ACTIVE}</TableCell>
                      </TableRow>
                    );
                  })}
                  {emptyRows > 0 && (
