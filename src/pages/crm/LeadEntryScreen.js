...
import { getListOfLeadDetailsToCrmRepAsync } from '../../redux/slices/leadSlice';
...
const TABLE_HEAD = [
  ...
  { id: 'is_ACTIVE', label: 'Active / InActive', alignRight: false },
  { id: 'remarks', label: 'REMARKS', alignRight: false }
  // { id: 'history', label: 'REMARKS HISTORY', alignRight: false }
];
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* <TableCell align="left">
                          ...
                          <IconButton color="primary" aria-label="view group" onClick={() => handlePreview(row18)}>
                            <VisibilityIcon />
                          </IconButton>
                        </TableCell> */}
                        <TableCell align="right">
                          <LeadMoreMenu leadId={leadId} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
