  ...
  useEffect(() => {
    axios
      .get(
        ...
        'https://secure.focusrtech.com:5050/techstep/api/Travel/Service/getListOfAllTravelDetails',
        {
          headers: {
    ...
    if (assignTo === '') {
      ...
      axios
        .put(
          ...
          'https://secure.focusrtech.com:5050/techstep/api/Travel/Service/changeStatusAdmin',
          [
            {
