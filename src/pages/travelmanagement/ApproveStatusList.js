  ...
  useEffect(() => {
    axios
      .get(
        ...
        'https://techstephub.focusrtech.com:3030/techstep/api/Travel/Service/getListOfAllTravelDetails',
        {
          headers: {
    ...
    if (assignTo === '') {
      ...
      axios
        .put(
          ...
          'https://techstephub.focusrtech.com:3030/techstep/api/Travel/Service/changeStatusAdmin',
          [
            {
